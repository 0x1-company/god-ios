...
public extension God {
  struct FriendRequestSheetFragment: God.SelectionSet, Fragment {
    public static var fragmentDefinition: StaticString {
      #"fragment FriendRequestSheetFragment on User { __typename id imageURL firstName displayName { __typename ja } votedCount username school { __typename id shortName } grade }"#
    }
