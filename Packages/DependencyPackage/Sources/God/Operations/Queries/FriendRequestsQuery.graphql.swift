...
public extension God {
  class FriendRequestsQuery: GraphQLQuery {
    ...
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query FriendRequests($first: Int!) { friendRequests(first: $first) { __typename edges { __typename node { __typename ...FriendRequestSheetFragment } } } }"#,
        fragments: [FriendRequestSheetFragment.self]
      ))
      ...
      public struct FriendRequests: God.SelectionSet {
        ...
        public struct Edge: God.SelectionSet {
          ...
          public struct Node: God.SelectionSet {
            ...
            public static var __selections: [ApolloAPI.Selection] { [
              .field("__typename", String.self),
              .fragment(FriendRequestSheetFragment.self),
            ] }

            public var id: God.ID { __data["id"] }
            /// ユーザー情報
            public var user: FriendRequestSheetFragment.User { __data["user"] }

            public struct Fragments: FragmentContainer {
              public let __data: DataDict
              public init(_dataDict: DataDict) { __data = _dataDict }

              public var friendRequestSheetFragment: FriendRequestSheetFragment { _toFragment() }
            }
          }
        }
      }
