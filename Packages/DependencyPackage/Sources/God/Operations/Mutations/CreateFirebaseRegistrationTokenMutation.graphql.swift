...
public extension God {
  class CreateFirebaseRegistrationTokenMutation: GraphQLMutation {
    ...
    public struct Data: God.SelectionSet {
      ...
      public struct CreateFirebaseRegistrationToken: God.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: ApolloAPI.ParentType { God.Objects.FirebaseRegistrationToken }
        public static var __selections: [ApolloAPI.Selection] { [
